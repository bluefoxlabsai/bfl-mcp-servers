...
# AccuWeather MCP Helm Chart Uninstallation Script
#
# Usage:
...
#   ./uninstall.sh my-accuweather-mcp # Uninstall with custom release name
#   ./uninstall.sh --dry-run          # Show what would be deleted
#   NAMESPACE=weather ./uninstall.sh  # Uninstall from 'weather' namespace
...
print_color $BLUE "🗑️  AccuWeather MCP Helm Chart Uninstaller"
echo ""
...
print_color $YELLOW "   - AccuWeather API key secret"
...
print_color $YELLOW "🌤️  Uninstalling AccuWeather MCP..."
