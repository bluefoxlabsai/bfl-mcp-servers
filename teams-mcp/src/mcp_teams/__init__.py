...
from mcp_teams.utils.lifecycle import (
    ensure_clean_exit,
    setup_signal_handlers,
)
from mcp_teams.utils.logging import setup_logging

try:
    __version__ = version("mcp-teams")
...
@click.version_option(__version__, prog_name="mcp-teams")
@click.command()
@click.option(
    "-v",
    "--verbose",
...
def main(
    ...
    """MCP Teams Server - Microsoft Teams functionality for MCP

    Supports Microsoft Teams messaging, channels, meetings, and collaboration.
    ...
    from mcp_teams.servers import main_mcp
