...
#   ./uninstall.sh my-nasdaq-mcp      # Uninstall with custom release name
#   ./uninstall.sh --dry-run          # Show what would be deleted
#   NAMESPACE=nasdaq ./uninstall.sh   # Uninstall from 'nasdaq' namespace
...
print_color $YELLOW "�️  Uninstalling Nasdaq Data Link MCP..."
